...
router.get("/:id", (req,res) {
    ...
    .catch (error => {
        res.status(500).json({errorMessage: "Error fetching classes by learner id"})
    })
})
...
router.get("/questions/:id", (req,res) => {
    ...
    .catch (error => {
        res.status(500).json({errorMessage: "Error fetching questions by class Id"})
    })
})
...
router.get("/q/:id", (req,res) => {
    ...
    .catch (error => {
        res.status(500).json({errorMessage: "Error getting question by question id"})
    })
})
